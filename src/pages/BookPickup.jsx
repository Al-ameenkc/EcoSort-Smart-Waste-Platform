...
import { MapPin, Phone, Upload, Map as MapIcon, User, CheckCircle, Crosshair, ChevronDown, Trash2, Scale } from 'lucide-react';
...
const GlassDropdown = ({ label, icon: Icon, options, placeholder }) => {
  ...
  return (
    <div className="space-y-1 relative" ref={dropdownRef}>
      ...
      {/* Dropdown Menu (The Glassy List) */}
      {isOpen && (
        <div className="absolute z-50 w-full mt-2 bg-white/90 backdrop-blur-xl border border-white/40 rounded-xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200 origin-top">
                ...
                <form className="space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            {/* CUSTOM GLASS DROPDOWN: Waste Type */}
                            <GlassDropdown 
                                label="Waste Type"
                                icon={Trash2}
                            ...
                            {/* CUSTOM GLASS DROPDOWN: Quantity */}
                            <GlassDropdown 
                                label="Est. Quantity"
                                icon={Scale}
                                placeholder="Select Size..."
                                options={[
                                    "Full Trash Bag (Minimum)",
                                    "Large Sack (Rice Bag)",
                                    "Pickup Truck Load"
                                ]}
                            />

  ...
  return (
    ...
    >
      ...
      <div className="p-4 border-t border-white/10">
        <button className={`w-full flex items-center gap-3 px-4 py-3 text-red-300 hover:bg-red-500/10 hover:text-red-200 rounded-xl transition-colors ${collapsed ? 'justify-center' : ''}`}>
            <LogOut size={20} />

...
import { LayoutDashboard, Users, ChevronLeft, ChevronRight, LogOut, Navigation, CloudRain, AlertTriangle, X } from 'lucide-react';
...
const Sidebar = ({ activeTab, setActiveTab, onLogout, mobileOpen, onCloseMobile }) => {
  ...
  const menuItems = [
    ...
    { id: 'logistics', label: 'Flood Logistics', icon: CloudRain },
  ];
